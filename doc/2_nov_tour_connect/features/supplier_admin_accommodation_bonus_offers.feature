Feature: Supplier Admin manage accommodation bonus offers
  As a Supplier Admin ISBAT manage accommodation bonus offers
  ...
  @javascript
  Scenario: Specifying accommodation bonus offers
    Given "Planet Express" has the following accommodations:
      | name                  |
      | Awesome Accommodation |
    And  I am on the "special_offers" step of the edit admin "Awesome Accommodation" accommodation page
    ...
    Then the "Awesome Accommodation" bonus offers should have the following values:
    ...
    Then the "Awesome Accommodation" stay pay deals should not have the following values:
      | booking_code |
      | 2BC12345     |
    And the "Awesome Accommodation" bonus offer "BC12345" date ranges should have the following values:
      | from       | to         |
      | 2011-10-01 | 2012-10-01 |
      | 2011-09-01 | 2012-09-01 |
    And the "Awesome Accommodation" bonus offer "BC12345" date ranges should not have the following values:
      | from       | to         |
      | 2011-08-01 | 2012-08-01 |
    And the "Awesome Accommodation" bonus offer "1BC12345" date ranges should have the following values:
      | from       | to         |
      | 2006-10-01 | 2007-10-01 |
      | 2006-09-01 | 2007-09-01 |
    And the "Awesome Accommodation" bonus offer "1BC12345" date ranges should not have the following values:
      | from       | to         |
