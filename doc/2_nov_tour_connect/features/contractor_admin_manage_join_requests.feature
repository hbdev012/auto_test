Feature: Contractor admin manage join requests
  ...
  Scenario: Contractor Admin viewing pending requests
    Given the following users:
      | email              | company_name   | role  | confirmed | pending |
  ...
  Scenario: Contractor Admin accept pending request
  ...
  @javascript
  Scenario: Contractor Admin reject pending request
    Given I sign in as "admin@test.com/please"
    And   I follow "Users"
  ...
  @javascript
  Scenario: Contractor Admin reject pending request with reason
    Given I sign in as "admin@test.com/please"
    And   I follow "Users"
    When  I press "Reject" within "#pending-users"
