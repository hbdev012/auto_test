Feature: Sign up
  As a guest
  I should be able to sign up as a Supplier
  ...
  Scenario: Supplier signs up with valid data
    Given I choose "Supplier"
    ...
    And  "Planet Express" in "United States" should be a supplier

  Scenario: Supplier signs up with invalid email
    Given I choose "Supplier"
    And I fill in the following:
      | First name            | Testy          |
      | Last name             | McUserton      |
  ...
  Scenario: Supplier signs up without password
    Given I choose "Supplier"
    And I fill in the following:
      | First name            | Testy          |
      | Last name             | McUserton      |
  ...
  Scenario: Supplier signs up without password confirmation
    Given I choose "Supplier"
    And I fill in the following:
      | First name            | Testy          |
      | Last name             | McUserton      |
  ...
  Scenario: Supplier signs up with mismatched password and confirmation
    Given I choose "Supplier"
    And I fill in the following:
      | First name            | Testy          |
      | Last name             | McUserton      |
  ...
  Scenario: Supplier signs up with existing company name
    Given I choose "Supplier"
    And   I fill in the following:
      | First name            | Testy          |
      | Last name             | McUserton      |
  ...
  Scenario: Supplier signs up with existing company name in a different country
    Given I choose "Supplier"
    And   I fill in the following:
      | First name            | Testy          |
      | Last name             | McUserton      |
    ...
    And  "Planet Express" in "Australia" should be a supplier
  ...
  Scenario: Supplier signs up with existing company name (invalid)
    Given I choose "Supplier"
    And   I fill in the following:
      | First name            | Testy          |
      | Last name             | McUserton      |
  ...
  Scenario: Company name autocomplete limited to 5 results
    Given the following companies:
      ...
      | Planet Hollywood   | Supplier   | United States |
      | Planet Pizza       | Supplier   | United States |
      | Planet Taco        | Supplier   | United States |
  ...
  @javascript
  Scenario: Signing up as a supplier choosing from an existing company
    Given the following companies:
      | name               | _type      | country       |
      | Planet Express     | Supplier   | United States |
      | Planet of the apes | Contractor | United States |
  ...
  @javascript
  Scenario: Signing up as a supplier choosing from an existing company, then de-select
  Given the following companies:
    | name               | _type      | country       |
    | Planet Express     | Supplier   | United States |
    | Planet of the apes | Contractor | United States |
  ...
  And  "cat@test.com" should be an admin
  And  "Dev Fu" in "United States" should be a supplier

  @javascript
  Scenario: Signing up as a supplier and rejecting all existing companies
    Given the following companies:
      | name               | _type      | country       |
      | Planet Express     | Supplier   | United States |
      | Planet of the apes | Contractor | United States |
    ...
    And  "cat@test.com" should be an admin
    And  "Planet" in "United States" should be a supplier
