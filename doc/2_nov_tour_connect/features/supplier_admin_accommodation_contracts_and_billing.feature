Feature: Supplier Admin manage accommodation contracts and billing information
  As a Supplier Admin ISBAT manage accommodation contract and billing information
  ...
  Scenario: Specify corporate information
    ...
    And I am on the "contracts_and_billing" step of the edit admin "Awesome Accommodation" accommodation page
    ...
    Then "Awesome Accommodation" property billing information should have the following values:
    ...
    And "Awesome Accommodation" property terms should have the following values:
      | terms               |
      | These are the terms |
    And "Awesome Accommodation" property insurance information should have the following values:
      | name                  | expires_on |
      | Primary Insurance Doc | 2015-01-01 |
    And "Awesome Accommodation" property insurance documents should have the following values:
      | attachment_name |
      | insurance.pdf   |
      | insurance.jpg   |
  ...
  Scenario: Specify all corporate information
    ...
    When I press "Save & Preview"
    And "Awesome Accommodation" property billing information should be the same as corporate
    And "Awesome Accommodation" property terms should be the same as corporate
    And "Awesome Accommodation" property insurance information should be the same as corporate
