Feature: Supplier Admin manage non-accommodation bonus offers
  ...
  Scenario: displaying the correct fields for bonus offer rate type
    ...
    And I am on the "special_offers" step of the edit admin "Awesome Non Accommodation" non accommodation page
    And I follow "Add a bonus offer"
    And I should not see the "Number" field
    And I should not see the "Maximum Number" field
    And I select "Per number of guests" from "Rate Type"
    Then I should see the "Number" field
    And I should see the "Maximum Number" field
    And I select "Per night" from "Rate Type"
    And I should not see the "Number" field
    And I should not see the "Maximum Number" field
  ...
  @javascript
  Scenario: Specifying non accommodation bonus offers
    Given "Planet Express" has the following non accommodations:
      | name                      |
      | Awesome Non Accommodation |
    And  I am on the "special_offers" step of the edit admin "Awesome Non Accommodation" non accommodation page

    When I follow "Add a bonus offer"

    And  I fill in "Offer Title" with "Honeymoon Bonus" within "#bonus-offers > .fields:nth-child(1)"
    ...
    Then the "Awesome Non Accommodation" bonus offers should have the following values:
    ...
    And the "Awesome Non Accommodation" bonus offer "BC12345" date ranges should have the following values:
      | from       | to         |
      | 2011-10-01 | 2012-10-01 |
      | 2011-09-01 | 2012-09-01 |
    And the "Awesome Non Accommodation" bonus offer "BC12345" date ranges should not have the following values:
      | from       | to         |
      | 2011-08-01 | 2012-08-01 |
    And the "Awesome Non Accommodation" bonus offer "1BC12345" date ranges should have the following values:
      | from       | to         |
      | 2006-10-01 | 2007-10-01 |
      | 2006-09-01 | 2007-09-01 |
    And the "Awesome Non Accommodation" bonus offer "1BC12345" date ranges should not have the following values:
      | from       | to         |
